<template>
  <div v-if="visible" class="publish-overlay" @click="onCancel">
...
export default {
  ...
  methods: {
    ...
    async onConfirm() {
      // If a questionnaireId is provided, perform publish here and redirect
      // to the questionnaire list on success. Otherwise, emit confirm and
      // let the parent handle publish logic.
      if (this.questionnaireId) {
        try {
          const { success, message } = await publishQuestionnaire(

...
export default {
  ...
  methods: {
    ...
    async add() {
      ...
      try {
        const response = await siteContentAPI.createDocumentCategory({
          name: this.catName,
        });
    ...
    async getData() {
      ...
      try {
        const response = await siteContentAPI.getDocumentCategories({
        ...
        this.handleError(
          error.response?.data?.message || "Failed to load document categories"
        );
      } finally {
        this.appLoading = false;
      }
    ...
    async edit() {
      ...
      try {
        ...
        const response = await siteContentAPI.updateDocumentCategory(
          categoryId,
          {
    ...
    async deleteItem(r) {
      ...
      try {
        ...
        const response = await siteContentAPI.deleteDocumentCategory(
          categoryId
        );
    ...
    handleError(message) {
      console.error("Document Category error:", message);
      this.msg = message;
      this.showSnackBar = true;
      this.appLoading = false;
      this.ServerError =

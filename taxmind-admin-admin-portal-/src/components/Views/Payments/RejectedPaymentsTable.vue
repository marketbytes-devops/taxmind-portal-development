          ...
          <v-layout wrap justify-center>
            <v-flex xs12>
              <v-data-table :headers="headers" :items="paymentsList" class="elevation-0 rejected-table"
                hide-default-footer :items-per-page="limit" :mobile-breakpoint="600" :disable-pagination="true">
                ...
                <template v-slot:item="{ item, index }">
                  <tr style="cursor: pointer" @click="viewPaymentDetails(item)">
                    ...
                    <td class="body-cell">{{ item.application.applicationNo || item.invoice || '-' }}</td>
...
<script>
import { listrejected } from "@/api/modules/payments";

<template>
  <div>
    ...
    <v-layout wrap justify-center pt-5 pt-sm-16 pb-10>
      <v-flex xs12 pa-6 pt-16>
...
export default {
  ...
  metaInfo: {
    title: "TaxMind FAQs - Find Answers to Your Tax Queries",
    meta: [
      {
        name: "description",
        content:
          "Find answers to common tax-related questions at TaxMind FAQs. Learn about tax filing, deductions, refunds, and more to simplify your tax process.",
      },
      {
        name: "keywords",
        content:
          "tax FAQs, tax questions, tax filing help, tax deductions, tax refunds, e-filing support, income tax queries, TaxMind support, tax guidance",
      },
      {
        property: "og:title",
        content: "TaxMind FAQs - Your Guide to Easy Tax Filing",
      },
      {
        property: "og:description",
        content:
          "Get quick answers to your tax-related queries with TaxMind FAQs. Learn about tax filing, refunds, deductions, and expert tax guidance.",
      },
      {
        property: "og:url",
        content: "https://www.taxmind.ie/faqs", // Replace with your actual website URL
      },
      {
        property: "og:type",
        content: "website",
